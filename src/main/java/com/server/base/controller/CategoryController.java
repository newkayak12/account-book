...
public class CategoryController {
    ...
    @ApiOperation(value = "카테고리 삭제/숨기기")
    @DeleteMapping(value = "/remove")
    public Response removeCategory(@RequestHeader(name = "Authorization") Object userDto, @ModelAttribute CategoryDto categoryDto) throws ServiceException {
        categoryDto.setUser((UserDto) userDto);
