...
public class CategoryTest extends BaseTest {
    ...
    void saveNewOneTest(){
        ...
        CategoryDto dto  = CategoryDto.builder().cateIsBasic(false).cateImage(img).isOutcome(false).cateFlag(true).cateName("APPLE").build();
        this.post("/save",dto );
    }
    @Test
    @DisplayName("modifyCategoryTest")
